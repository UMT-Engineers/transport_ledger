 ...
 @section('content')
    ...
    <!-- Main content -->
     <section class="content">
      <form role="form" action="update_company_submit" method="POST">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <input type="hidden" name="cid" value="{{$company['cid']}}">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                  <input type="text" class="form-control" name="name" placeholder="Enter name" id="weight" value="{{$company['name']}}">
                  </div>
                  <label for="exampleInput" class="col-sm-3">Phone</label>
                  <div class="col-md-3">
                  <input type="text" class="form-control" name="phone" placeholder="Enter phone" id="weight" value="{{$company['phone']}}">
                </div>
                </div>
              </div>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                  <input type="text" class="form-control" name="address" placeholder="Enter address" id="weight" value="{{$company['address']}}">
                  </div>
                  <label for="exampleInput" class="col-sm-3">PTN</label>
                  <div class="col-md-3">
                  <input type="text" class="form-control" name="PTN" placeholder="Enter PTN" id="weight" value="{{$company['PTN']}}">
                </div>
                </div>
              </div>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                  <input type="text" class="form-control" name="NTN" placeholder="Enter NTN" id="c_rate" value="{{$company['NTN']}}" >
