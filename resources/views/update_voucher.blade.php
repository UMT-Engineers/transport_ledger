              ...
              <div class="box-body">
               ...
               @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="textbox" class="form-control" id="inputPassword3" placeholder="Amount" name="Amount">
                  </div>
                  <label for="inputPassword3" class="col-sm-2 control-label">Amount in word</label>

                  <div class="col-sm-5">
                    <input type="textbox" class="form-control" id="inputPassword3" placeholder="Amount in words" name="AmountInWord">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="textbox" class="form-control" id="inputPassword3" placeholder="Bank name">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Description</label>
                   <div class="col-sm-10">
                    <input type="textbox" class="form-control" id="inputPassword3" placeholder="Description" name="Description">
                  </div>
