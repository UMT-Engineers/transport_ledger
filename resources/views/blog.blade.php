      ...
      <div class="container">
        <div class="row align-items-center">
         ...
         <div class="col-11 col-md-5">
            <h1 class="mb-0"><img src="images/Logo_LCG.png"><a href="index.html" class="text-white h3 mb-0"><b> Land Connect Group</b> </a></h1>
          </div>
          <div class="col-12 col-md-7 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li><a href="about.html">About LCG</a></li>
                <li class="has-children">
                  <a href="services.html">LCG Services</a>
                  <ul class="dropdown">
                    <li><a href="#">Ground Shipping</a></li>
                    <li><a href="#">Warehousing</a></li>
                    <li><a href="#">Storage</a></li>
                    <li><a href="#">Delivery Van</a></li>
                  </ul>
                </li>
                <li class="active"><a href="blog.html">Blog</a></li>
                <li><a href="contact.html">Contact LCG</a></li>
              </ul>
            </nav>
          </div>
