     ...
     <!-- Small boxes (Stat box) -->
        <div class="row">
          <form action="search" method="post" class="">
            <input type="hidden" value="list_bilty_reached" name="page">
        ...
        <!-- /.row -->
        <!-- main row -->
        <form action="bilty_invoice" method="POST">
          @csrf
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Reached Bilties</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    @foreach ($biltys as $bilty)
                    <tr>
                      <td><input type="checkbox" name="bilty[]" value="{{$bilty['buid']}}"></td>
                    ...
                    <td>{{$company['name']}}</td>
                      ...
                      <!-- <th>{{$bilty['debit_cost']}}</th> -->
                      <th><a href="{{ url('update_bilty'.$bilty['buid'])}}"> update</a></th>
                    </tr>
                     @endforeach
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <button type="submit" class="btn btn-info pull-right" id="sbtbtn" name="Company" value="Company invoice">Company Invoice</button>
                 <input  type="text" class="form-control" style="width: 20%;float: right;" name="tax" placeholder="Enter sales tax in %" id="tax" >
