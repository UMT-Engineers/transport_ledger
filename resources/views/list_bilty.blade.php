      ...
      <section class="content">
        ...
        <div class="row">
          <form action="search" method="post" class="">
            <input type="hidden" value="list_bilty" name="page">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><b>Bilties Details</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example2" class="table table-bordered table-hover" class="col-xs-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$bilty['total_cost']}}</td>
                  <td>{{$bilty['pay_to_broker']}}</td>
                  ...
                  if($bilty['r_weight']==0.00)
                  {
                    ...
                    echo "<th><a href=";?>
                    "{{ url('delete_bilty'.$bilty['buid'])}}"
                    <?php echo "
                    > Delete</a></th>
                    <th><form action='bilty_reached' method='POST'>
                    <div class='form-group'>
                    <input type='hidden' name='buid' value='{$bilty['buid']}'>
                    <input  type='text' class='form-control' style='width: 50%' name='r_weight' placeholder='Enter recevied weight' id='r_weight' >";?>
                    @csrf
                    <?php echo"<button type='submit' class='btn btn-info pull-right' >Reached</button>
                    </div>
                    </th>
                    </form>";
                  }
